...
protected:
    mat_aes_t _plain{vector<AESByte>({0x00, 0x44, 0x88, 0xcc,
                                      0x11, 0x55, 0x99, 0xdd,
                                      0x22, 0x66, 0xaa, 0xee,
                                      0x33, 0x77, 0xbb, 0xff}), 4, 4};

    mat_aes_t _cipher128{vector<AESByte>({0x69, 0x6a, 0xd8, 0x70,
                                          0xc4, 0x7b, 0xcd, 0xb4,
                                          0xe0, 0x04, 0xb7, 0xc5,
                                          0xd8, 0x30, 0x80, 0x5a}), 4, 4};

    mat_aes_t _cipher192{vector<AESByte>({0xdd, 0x86, 0x6e, 0xec,
                                          0xa9, 0x4c, 0xaf, 0x0d,
                                          0x7c, 0xdf, 0x70, 0x71,
                                          0xa4, 0xe0, 0xa0, 0x91}), 4, 4};

    mat_aes_t _cipher256{vector<AESByte>({0x8e, 0x51, 0xea, 0x4b,
                                          0xa2, 0x67, 0xfc, 0x49,
                                          0xb7, 0x45, 0x49, 0x60,
                                          0xca, 0xbf, 0x90, 0x89}), 4, 4};

    mat_aes_t _key{vector<AESByte>({0x00, 0x04, 0x08, 0x0c, 0x10, 0x14, 0x18, 0x1c,
