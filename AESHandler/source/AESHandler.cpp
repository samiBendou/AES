...
const vec_aes_t AESHandler::s_box = {
...
const vec_aes_t AESHandler::inv_s_box = {
...
const mat_aes_t AESHandler::mat_mix_columns = {{0x02, 0x03, 0x01, 0x01},
                                               {0x01, 0x02, 0x03, 0x01},
                                               {0x01, 0x01, 0x02, 0x03},
                                               {0x03, 0x01, 0x01, 0x02}};

const mat_aes_t AESHandler::inv_mat_mix_columns = {{0x0e, 0x0b, 0x0d, 0x09},
                                                   {0x09, 0x0e, 0x0b, 0x0d},
                                                   {0x0d, 0x09, 0x0e, 0x0b},
                                                   {0x0b, 0x0d, 0x09, 0x0e}};


const mat_aes_t AESHandler::r_con = {{0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36, 0x6c, 0xd8, 0xab},
