...
const vec_aes_t AESHandler::inv_s_box = vec_aes_t(vector<AESByte>({
                                                                          ,
...
const mat_aes_t AESHandler::inv_mat_mix_columns = mat_aes_t(std::vector<AESByte>{
        0x0e, 0x0b, 0x0d, 0x09,
        0x09, 0x0e, 0x0b, 0x0d,
        0x0d, 0x09, 0x0e, 0x0b,
        0x0b, 0x0d, 0x09, 0x0e}, N_ROWS_STATE, N_ROWS_STATE);
...
mat_aes_t AESHandler::decrypt(const mat_aes_t &cipher, const mat_aes_t &key) {

    assert(cipher.n() == N_ROWS_STATE && cipher.p() == _n_b);
    assert(key.n() == N_ROWS_STATE && key.p() == _n_k);
...
void AESHandler::invSubBytes(mat_aes_t &block) {
    for (uc_t i = 0; i < N_ROWS_STATE; ++i) {
        for (uc_t j = 0; j < _n_b; ++j) {
            block(i, j) = inv_s_box(block(i, j).val());
        }
    }
}

void AESHandler::invShiftRows() {
    for (uc_t i = 0; i < N_ROWS_STATE; ++i) {
        _state.shiftRow(i, -i);
    }
}

void AESHandler::invMixColumns() {
    _state = inv_mat_mix_columns * _state;
}
